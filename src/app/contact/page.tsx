        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to transform your health and fitness journey? Get in touch with us today.
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919876543210" className="text-pink-600 hover:text-pink-700">
                        +91 98765 43210
                      </a>
                    </div>
                  </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="block w-full bg-green-500 text-white py-3 px-6 rounded-lg font-semibold text-center hover:bg-green-600 transition-all duration-300"
                  >
                    WhatsApp Us Now
                  </a>
                </div>
